...
/**
 * Enhanced TreeSelector listener implementation with wildcard support
 */
class EnhancedTreeSelectorListenerImpl extends TreeSelectorBaseListener {

	private TreeNode rootNode;
	private List<TreeNode> currentNodes = new ArrayList<>();
	private List<TreeNode> resultNodes = new ArrayList<>();

	public EnhancedTreeSelectorListenerImpl(TreeNode rootNode) {
